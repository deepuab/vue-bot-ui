<template>
  <div class="part" :class="position">
    ...
    <!-- Passing data to custom directives using args and modifiers -->
    <!-- <span v-pin:position.top.right class="sale" v-show="selectedPart.onSale">Sale!</span> -->
    <!-- Passing data to custom directives as objects -->
    <span
      v-pin="{bottom:'10px',right:'10px'}" class="sale"
      v-show="selectedPart.onSale">Sale!
    </span>
  </div>
</template>
...
export default {
  // // Using custom directives to pin an element to bottom
